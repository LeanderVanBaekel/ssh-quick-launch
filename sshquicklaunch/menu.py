...
def command_menu(stdscr, base, host_extras, header_txt):
    stdscr.keypad(True)
...
def main_menu(stdscr, ssh_options, host_extras, header_txt, exit_cat):
    curses.curs_set(0)
    setup_colors()
    stdscr.keypad(True)
    ...
    while True:
        ...
        if k in (ord('q'), ord('Q')):
            ...
            if command_menu(stdscr, base, host_extras, header_txt):
                return
